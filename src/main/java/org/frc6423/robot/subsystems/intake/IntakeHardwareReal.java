...
public class IntakeHardwareReal extends IntakeHardware {
    ...
    private final PositionTorqueCurrentFOC poseReq = new PositionTorqueCurrentFOC(0);
    private final VelocityTorqueCurrentFOC velReq = new VelocityTorqueCurrentFOC(0);
